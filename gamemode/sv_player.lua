...
GM.CombineRadioFreq = 275; -- Fucked by Neomi Ishida
...
function nDropRation( len, ply )
	...
	if( GAMEMODE:LookupCombineFlag( ply:ActiveFlag() ) ) then
		...
		if( GAMEMODE:Rations() > 0 ) then
			...
			GAMEMODE:CreateItem( ply, "citration" );
...
function nDropLoyRation( len, ply )
	...
	if( GAMEMODE:LookupCombineFlag( ply:ActiveFlag() ) ) then
		...
		if( GAMEMODE:Rations() > 0 ) then
			...
			GAMEMODE:CreateItem( ply, "loyration" );
...
net.Receive( "nDropLoyRation", nDropLoyRation );

function nDropBioRation( len, ply )
	...
	if( GAMEMODE:LookupCombineFlag( ply:ActiveFlag() ) ) then
		...
		if( GAMEMODE:Rations() > 0 ) then
			...
			GAMEMODE:CreateItem( ply, "bioration" );
...
net.Receive( "nDropBioRation", nDropBioRation );

function nDropPenRation( len, ply )
	...
	if( GAMEMODE:LookupCombineFlag( ply:ActiveFlag() ) ) then
		...
		if( GAMEMODE:Rations() > 0 ) then
			...
			GAMEMODE:CreateItem( ply, "penration" );
...
net.Receive( "nDropPenRation", nDropPenRation );

function nDropPriRation( len, ply )
	...
	if( GAMEMODE:LookupCombineFlag( ply:ActiveFlag() ) ) then
		...
		if( GAMEMODE:Rations() > 0 ) then
			...
			GAMEMODE:CreateItem( ply, "priration" );
...
net.Receive( "nDropPriRation", nDropPriRation );
