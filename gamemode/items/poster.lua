...
ITEM.Description	= "A folded piece of poster paper. It has adhesive tape on the edges of the poster, allowing it to stick onto walls with ease. The poster would have multiple pictures of propaganda. There would also be a bag of credits stapled onto the bottom of the poster.";
...
ITEM.OnPlayerUse	= function( self, ply )
	...
	if( tr.HitWorld ) then
		...
		if( SERVER ) then
			...
			if( ply:HasTrait( TRAIT_LOYALIST ) ) then
