ITEM.ID				= "paper";
ITEM.Name			= "Paper";
ITEM.Description	= "It's a blank piece of paper seemingly ripped from a notebook. It can be used to write notes and such, but you only have a limited amount of space to write before you need another piece of paper.";
