ITEM.ID					= "clothes_shirt_trench";
ITEM.Name				= "Trenchcoat";
ITEM.Description		= "A large mass of leather, it's tattered and worn. Often very marked as suspicious when worned.";
