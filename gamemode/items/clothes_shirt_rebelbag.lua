ITEM.ID				= "clothes_shirt_rebelbag";
ITEM.Name                       = "Rebel Vest with Bag"
ITEM.Description        = "A modified metrocop vest worn with Lambda insignia and armpads. Slung messenger bag."
