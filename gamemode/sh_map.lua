...
GM.GlobalVariables = {
	...
	{ "BioticRations",		"Float",	30 },

	{ "PenaltyRations",		"Float",	30 },

	{ "LoyalistRations",	"Float",	30 },

	{ "PriorityRations",	"Float",	30 },
...
function GM:RefillThink()
	...
	if( CurTime() >= self.NextCombineRefill ) then
		...
		self:SetPenaltyRations( 30 );

		self:SetLoyalistRations( 30 );

		self:SetBioticRations( 30 );

		self:SetPriorityRations( 30 );
