...
util.AddNetworkString( "nCitizenRationNoCitizen" );
util.AddNetworkString( "nCitizenRationTooSoon" );
util.AddNetworkString( "nCitizenRationTooMuch" );
...
util.AddNetworkString( "nDropPenRation" );
util.AddNetworkString( "nDropBioRation" );
util.AddNetworkString( "nDropLoyRation" );
util.AddNetworkString( "nDropPriRation" );