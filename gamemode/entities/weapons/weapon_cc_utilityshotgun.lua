...
SWEP.PrintName 		= "Utility Shotgun";
SWEP.Slot 			= 2;
SWEP.SlotPos 		= 7;
...
SWEP.Itemize = true;
SWEP.ItemDescription = "This shotgun is dual loaded with beanbag and breaching rounds. The ultimate in dual-purpose weaponry.";
SWEP.ItemWeight = 10;
SWEP.ItemFOV = 37;
