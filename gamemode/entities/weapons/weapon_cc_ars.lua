...
SWEP.AimPos = Vector( -8, 2.8, -4.76 );
SWEP.AimAng = Vector( -4, -1, 0 );

SWEP.Itemize = true;
SWEP.ItemDescription = "The Pulse shotgun has become the Combine Overwatch Transhuman Arm's crowd-control method of choice. It functions using an internal tube magazine loaded with 6 rounds of deadly buckshot.";
SWEP.ItemWeight = 6;
SWEP.ItemFOV = 37;
