...
function ENT:Initialize()
	...
	self:SetModel( "models/tnb/items/workbench.mdll" );
...
function ENT:Think()
	...
	if( self:GetStoveOn() ) then
		...
		if( self:GetModel() == "models/tnb/items/workbench.mdl" ) then
...
function ENT:Use( ply )
	...
	if( SERVER ) then
		...
		if( ( !self.SteamEnt or !self.SteamEnt:IsValid() ) and self:GetModel() != "models/props_c17/tv_monitor01.mdl" ) then
			...
			if( string.lower( self:GetModel() ) == "models/tnb/items/workbench.mdl" ) then
