	...
	for _, v in pairs( self.Items ) do
		...
		if( bit.band( lic, v.License or -1 ) == v.License ) then
			...
			if( v.SinglePrice ) then
				...
				price:SetText( "1 for " .. v.BulkPrice .. " credits" );
...
function GM:PMCreateCombine()
	...
	if( LocalPlayer():HasAnyCombineFlag() ) then
		...
		if( GAMEMODE:LookupCombineFlag( LocalPlayer():ActiveFlag() ) ) then
			...
			CCP.PlayerMenu.RationBut:SetPos( 10, 10 );

			CCP.PlayerMenu.RationBut:SetSize( 100, 26 );
			...
			CCP.PlayerMenu.RationsLabel:SetPos( 10, 50 );
			...
			CCP.PlayerMenu.PenRationBut = vgui.Create( "DButton", CCP.PlayerMenu.ContentPane );

			CCP.PlayerMenu.PenRationBut:SetFont( "CombineControl.LabelSmall" );

			CCP.PlayerMenu.PenRationBut:SetText( "Drop PenRation" );

			CCP.PlayerMenu.PenRationBut:SetPos( 120, 10 );

			CCP.PlayerMenu.PenRationBut:SetSize( 100, 26 );

			CCP.PlayerMenu.PenRationBut.DoClick = function( self )

				

				if( GAMEMODE:PenaltyRations() > 0 ) then

					

					CCP.PlayerMenu.PenRationsLabel:SetText( "Remaining: " .. GAMEMODE:PenaltyRations() - 1 );

					

					net.Start( "nDropPenRation" );
			...
			CCP.PlayerMenu.PenRationBut:PerformLayout();
			...
			if( !flag or !flag.CanSpawn ) then
				...
				CCP.PlayerMenu.PenRationBut:SetDisabled( true );
			...
			CCP.PlayerMenu.PenRationsLabel = vgui.Create( "DLabel", CCP.PlayerMenu.ContentPane );

			CCP.PlayerMenu.PenRationsLabel:SetText( "Remaining: " .. GAMEMODE:PenaltyRations() );

			CCP.PlayerMenu.PenRationsLabel:SetPos( 120, 50 );

			CCP.PlayerMenu.PenRationsLabel:SetFont( "CombineControl.LabelSmall" );

			CCP.PlayerMenu.PenRationsLabel:SizeToContents();

			CCP.PlayerMenu.PenRationsLabel:PerformLayout();

			

			CCP.PlayerMenu.BioRationBut = vgui.Create( "DButton", CCP.PlayerMenu.ContentPane );

			CCP.PlayerMenu.BioRationBut:SetFont( "CombineControl.LabelSmall" );

			CCP.PlayerMenu.BioRationBut:SetText( "Drop BioRation" );

			CCP.PlayerMenu.BioRationBut:SetPos( 230, 10 );

			CCP.PlayerMenu.BioRationBut:SetSize( 100, 26 );

			CCP.PlayerMenu.BioRationBut.DoClick = function( self )

				

				if( GAMEMODE:BioticRations() > 0 ) then

					

					CCP.PlayerMenu.BioRationsLabel:SetText( "Remaining: " .. GAMEMODE:BioticRations() - 1 );

					

					net.Start( "nDropBioRation" );
			...
			CCP.PlayerMenu.BioRationBut:PerformLayout();
			...
			if( !flag or !flag.CanSpawn ) then
				...
				CCP.PlayerMenu.BioRationBut:SetDisabled( true );
			...
			CCP.PlayerMenu.BioRationsLabel = vgui.Create( "DLabel", CCP.PlayerMenu.ContentPane );

			CCP.PlayerMenu.BioRationsLabel:SetText( "Remaining: " .. GAMEMODE:BioticRations() );

			CCP.PlayerMenu.BioRationsLabel:SetPos( 230, 50 );

			CCP.PlayerMenu.BioRationsLabel:SetFont( "CombineControl.LabelSmall" );

			CCP.PlayerMenu.BioRationsLabel:SizeToContents();

			CCP.PlayerMenu.BioRationsLabel:PerformLayout();



			CCP.PlayerMenu.LoyRationBut = vgui.Create( "DButton", CCP.PlayerMenu.ContentPane );

			CCP.PlayerMenu.LoyRationBut:SetFont( "CombineControl.LabelSmall" );

			CCP.PlayerMenu.LoyRationBut:SetText( "Drop LoyRation" );

			CCP.PlayerMenu.LoyRationBut:SetPos( 340, 10 );

			CCP.PlayerMenu.LoyRationBut:SetSize( 100, 26 );

			CCP.PlayerMenu.LoyRationBut.DoClick = function( self )

				

				if( GAMEMODE:LoyalistRations() > 0 ) then

					

					CCP.PlayerMenu.LoyRationsLabel:SetText( "Remaining: " .. GAMEMODE:LoyalistRations() - 1 );

					

					net.Start( "nDropLoyRation" );
			...
			CCP.PlayerMenu.LoyRationBut:PerformLayout();
			...
			if( !flag or !flag.CanSpawn ) then
				...
				CCP.PlayerMenu.LoyRationBut:SetDisabled( true );
			...
			CCP.PlayerMenu.LoyRationsLabel = vgui.Create( "DLabel", CCP.PlayerMenu.ContentPane );

			CCP.PlayerMenu.LoyRationsLabel:SetText( "Remaining: " .. GAMEMODE:LoyalistRations() );

			CCP.PlayerMenu.LoyRationsLabel:SetPos( 340, 50 );

			CCP.PlayerMenu.LoyRationsLabel:SetFont( "CombineControl.LabelSmall" );

			CCP.PlayerMenu.LoyRationsLabel:SizeToContents();

			CCP.PlayerMenu.LoyRationsLabel:PerformLayout();

			

			CCP.PlayerMenu.PriRationBut = vgui.Create( "DButton", CCP.PlayerMenu.ContentPane );

			CCP.PlayerMenu.PriRationBut:SetFont( "CombineControl.LabelSmall" );

			CCP.PlayerMenu.PriRationBut:SetText( "Drop PriRation" );

			CCP.PlayerMenu.PriRationBut:SetPos( 450, 10 );

			CCP.PlayerMenu.PriRationBut:SetSize( 100, 26 );

			CCP.PlayerMenu.PriRationBut.DoClick = function( self )

				

				if( GAMEMODE:PriorityRations() > 0 ) then

					

					CCP.PlayerMenu.PriRationsLabel:SetText( "Remaining: " .. GAMEMODE:PriorityRations() - 1 );

					

					net.Start( "nDropPriRation" );
			...
			CCP.PlayerMenu.PriRationBut:PerformLayout();
			...
			if( !flag or !flag.CanSpawn ) then
				...
				CCP.PlayerMenu.PriRationBut:SetDisabled( true );
			...
			CCP.PlayerMenu.PriRationsLabel:SetText( "Remaining: " .. GAMEMODE:PriorityRations() );

			CCP.PlayerMenu.PriRationsLabel:SetPos( 450, 50 );

			CCP.PlayerMenu.PriRationsLabel:SetFont( "CombineControl.LabelSmall" );
